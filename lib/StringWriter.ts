...
function normalizeLineEndings(lineEnding: string | any, value: string | any): string {
...
export class StringWriter {
    ...
    write(filePath: string): void {
        ...
        if (this.config.normalizeLineEndingsTo !== false && this.config.normalizeLineEndingsTo !== undefined) {
            this.outputText = normalizeLineEndings(this.config.normalizeLineEndingsTo as string, this.outputText);
        }
