...
// [
//     /[a-zA-Z]{3} [a-zA-Z]{3} \\d{2} \\d{4} \\d{2}:\\d{2}:\\d{2}.\\d{3+/ig,
//     ["Tue May 13 2014 23:30:00.789"],
// ],
// [
//     /[a-zA-Z]{3} [a-zA-Z]{3} \\d{2} \\d{2}:\\d{2}:\\d{2} -\\d{4} \\d{4+/ig,
//     ["Tue May 13 16:30:00 -0800 2014"],
// ],
// [
//     /\\d{2} [a-zA-Z]{3} \\d{4} \\d{2}:\\d{2}:\\d{2},\\d{3}/ig,
//     ["13 May 2014 23:50:49,999"]
// ],
// [
//     /[a-zA-Z]{3} \\d{2}, \\d{4} \\d{2}:\\d{2}:\\d{2} [a-zA-Z]{2} [a-zA-Z]{3}/ig,
//     ["May 13, 2014 11:30:00 PM PST"],
// ],
// [/\\d{2}:\\d{2}:\\d{2}/ig, ["23:30:00"]],
// [
//     /\\d{4}/\\d{2}/\\d{2} \\d{2}:\\d{2}:\\d{2}.\\d{2}\\d/ig,
//     ["2014/05/13 16:30:59.786"]
// ],
// [
//     /\\d{4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{2}Z/ig,
//     [
//         "2020-9-10T08:07Z",
//     "2020-09-9T08:07Z",
//     "2020-09-10T8:07Z",
